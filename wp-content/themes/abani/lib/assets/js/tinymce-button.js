      ...
      menu: [
...

        {
          ...
          menu: [{
              ...
              text: 'Fancy text',
              onclick: function() {
                editor.insertContent('[mk_fancy_text color="#ffffff" highlight_color="#4f4f4f" highlight_opacity="0.3" size="18" line_height="34" font_weight="inhert" margin_top="0" margin_bottom="18" font_family="none" align="left"]Here is a text[/mk_fancy_text]');
              }
            }, {
              text: 'Text Block',
              onclick: function() {
              ...
              text: 'Call to Action',
              onclick: function() {
                editor.insertContent('[mk_call_to_action style="default" text_size="18" font_weight="inhert" text="Here is the content" button_text="Button Text" button_url="Button URL" outline_skin="#444" outline_hover_skin="#fff"]');
              }
            }
