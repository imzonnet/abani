<div class="wrap about-wrap">
    ...
    <p class="about-description"><?php _e( 'Redux is created by a community of developers world wide. Want to have your name listed too? <a href="#" target="_blank">Contribute to Redux</a>.', 'redux-framework' ); ?></p>
