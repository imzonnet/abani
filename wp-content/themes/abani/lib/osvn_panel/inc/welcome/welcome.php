<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo 'If you like <strong>Redux</strong> please leave us a <a href="#" target="_blank" class="redux-rating-link" data-rated="Thanks :)">5star</a> rating. A huge thank you from Redux in advance!';
        }
        ...
        public function actions() {
            ...
            <p class="redux-actions">
                <a href="#" class="docs button button-primary">Docs</a>
                <a href="#" class="review-us button button-primary"
                   target="_blank">Review Us</a>
                <a href="#" class="review-us button button-primary" target="_blank">Donate</a>
