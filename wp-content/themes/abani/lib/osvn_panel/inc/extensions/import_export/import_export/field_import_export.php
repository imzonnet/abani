        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                if ( ! $this->is_field || ( $this->is_field && false == $fullWidth ) ) : ?>
                    ...
                    <table id="<?php echo esc_attr($id); ?>" class="form-table no-border redux-group-table redux-raw-table" style=" overflow: <?php $this->field['overflow']; ?>;">
                    <tbody><tr><td>
                <?php
                    $bDoClose = true;
                endif;
                ?>
                <fieldset id="<?php echo esc_attr($id); ?>" class="redux-field redux-container-<?php echo esc_attr($this->field['type']) . ' ' . $this->field['class']; ?>" data-id="<?php echo esc_attr($this->field['id']); ?>">
