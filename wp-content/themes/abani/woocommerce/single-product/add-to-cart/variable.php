			...
			foreach ( $attributes as $name => $options ) : $loop ++; ?>
				<div class="options-size">
					...
					<select id="<?php echo esc_attr( sanitize_title( $name ) ); ?>"
					        ...
					        class="woo-attribute-custom-select">
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="variations_button">
				...
				<a class="wishlist-link"
				   href="<?php echo esc_url( add_query_arg( 'add_to_wishlist', get_the_ID() ) ); ?>"
				   rel="nofollow" data-product-id="<?php echo get_the_ID(); ?>"
				   data-product-type="<?php echo esc_attr($product->product_type); ?>"
					>
					<?php _e( 'Add to My Wish List', 'kysbag' ); ?>
				</a>
			</div>
