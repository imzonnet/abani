...
class Wcb_WooCommerce_Breadcrumbs{
	...
	public function wcb_add_settings_link( $links, $file ) {
		...
		if( $file == $this_plugin ) {
			$link_b = 'options-general.php?page=woocommerce-breadcrumbs';
			$settings_link = '<a href="'.$link_b.'">' . __( 'Settings', 'woocommerce-breadcrumbs' ) . '</a>';
...
$wcb_woocommerce_breadcrumbs = new Wcb_WooCommerce_Breadcrumbs();
